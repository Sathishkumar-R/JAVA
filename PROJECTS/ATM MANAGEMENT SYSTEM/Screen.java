...
public void createlogin() {
	...
	messageJLabel = new JLabel("  Enter your PIN number:    ");
	 ...
	 setInputfield2(new JTextField( 10 ));
...
public static JTextField getInputfield2() {
	return Inputfield2;
}

public static void setInputfield2(JTextField inputfield2) {
