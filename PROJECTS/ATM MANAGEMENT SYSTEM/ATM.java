...
public class ATM 
{
   ...
   private Deposit deposit; // ATM's deposit slot
   ...
   public ATM() 
   {
      ...
      deposit = new Deposit(AdminCheck, screen, bankDatabase, keypad, deposit); // create deposit slot
		...
		public void actionPerformed( ActionEvent e )
	      {
	        ...
	        int PIN = Integer.parseInt( screen.getInputfield2().getText() );
   ...
   // display the main menu and perform transactions
	...
	private void performTransactions(int a) 
      ...
      Transaction currentTransaction = null;
           ...
           userinput = "";
           screen.getInputfield2().setText(userinput);
...
public static int getBalanceInquiry() {
